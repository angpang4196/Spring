	...
	<div class='w3-main w3-light-grey' id='belowtopnav'
		...
		<div class='w3-row w3-white'>
			<div class='w3-col l10 m12' id='main'>
				...
				<h1>
					HTML5<span class="color_h1"> Tutorial</span>
				</h1>
				<div class="w3-clear nextprev">
					<a class="w3-left w3-btn" href="/default.asp">&#10094; Home</a> <a
						class="w3-right w3-btn" href="html_intro.asp">Next &#10095;</a>
				</div>
				...
				<p>With our online HTML editor, you can edit the HTML, and click
					on a button to view the result.</p>
				<div class="w3-example">
					<h3>Example</h3>
					<div class="w3-code notranslate htmlHigh">
						&lt;!DOCTYPE html&gt;<br> &lt;html&gt;<br>&lt;head&gt;<br>&lt;title&gt;Page
						Title&lt;/title&gt;<br> &lt;/head&gt;<br>&lt;body&gt;<br>
						<br>&lt;h1&gt;This is a Heading&lt;/h1&gt;<br>&lt;p&gt;This
						is a paragraph.&lt;/p&gt;<br> <br> &lt;/body&gt;<br>&lt;/html&gt;
					</div>
					<a class="w3-btn w3-margin-bottom"
						href="tryit.asp?filename=tryhtml_default" target="_blank">Try
						it Yourself &raquo;</a>
				</div>
				<p>
					<strong>Click on the &quot;Try it Yourself&quot; button to
						see how it works.</strong>
				</p>
				<p>
					<a href="html_intro.asp">Start learning HTML now!</a>
				</p>
				<hr>

				<h2>HTML Examples</h2>
				<p>At the end of the HTML tutorial, you can find more than 200
					examples.</p>
				<p>With our online editor, you can edit and test each example
					yourself.</p>
				<p>
					<a href="html_examples.asp">Go to HTML Examples!</a>
				</p>
				<hr>
				...
				<p>
					<a href="exercise.asp?filename=exercise_attributes1"
						target="_blank">Start HTML Exercises!</a>
				</p>
				<p>
					<a href="html_quiz.asp">Start HTML Quiz!</a>
				</p>
				<hr>
				...
				<p>At W3Schools you will find complete references about tags,
					...
					encoding, language codes, HTTP messages, and more.</p>
				<p>
				...
				<div class="w3-row">
					<div class="w3-third w3-container w3-padding-24">
						<a href="/cert/default.asp"><img src="/images/w3cert.gif"
							style="width: 100%;" alt="W3Schools Certification" /></a>
					</div>
					<div class="w3-twothird w3-container">
						<h2>W3Schools' Online Certification</h2>
						<p>The perfect solution for professionals who need to balance
							work, family, and career building.</p>
						<p>More than 10 000 certificates already issued!</p>
					</div>
				</div>
				<p>
					<a class="w3-btn" href="/cert/default.asp">Get Your Certificate
						&raquo;</a>
				</p>
				<p style="clear: both;">
					The <a href="/cert/default.asp">HTML Certificate</a> documents your
					knowledge of HTML.
				</p>
				<p>
					The <a href="/cert/default.asp">CSS Certificate</a> documents your
					knowledge of advanced CSS.
				</p>
				<p>
					The <a href="/cert/default.asp">JavaScript Certificate</a>
					documents your knowledge of JavaScript and HTML DOM.
				</p>
				<p>
					The <a href="/cert/default.asp">jQuery Certificate</a> documents
					your knowledge of jQuery.
				</p>
				<p>
					The <a href="/cert/default.asp">PHP Certificate</a> documents your
					knowledge of PHP and SQL (MySQL).
				</p>
				<p>
					The <a href="/cert/default.asp">XML Certificate</a> documents your
					knowledge of XML, XML DOM and XSLT.
				</p>
				<p>
					The <a href="/cert/default.asp">Bootstrap Certificate</a> documents
					your knowledge of the Bootstrap framework.
				</p>
				...
				<div class="sidesection">
					...
					<div class="w3-text-grey sharethis">
						...
						<br> <br> <a href="javascript:void(0);"
							onclick="clickFBLike()" title="Like W3Schools on Facebook"> <span
		...
		<div id="footer" class="footer w3-container w3-white">
			...
			<div class="w3-center w3-small w3-opacity">
				...
				Refsnes Data. All Rights Reserved.<br> <a
					href="//www.w3schools.com/w3css/">Powered by W3.CSS</a>.<br> <br>
				<a href="//www.w3schools.com"> <img
