...
<body>
	...
	<section>
		<!--에러코드, 가이드, 커스텀박스묶음-->            
        <div id="allbox">
       	<img src="/img/ERcode.png" id="all1"class="boxcollection" alt="에러코드박스" > 
		<img src="/img/guide.png" id="all2" class="boxcollection" alt="가이드박스" usemap="#boxlink">
		<img src="/img/custom.png" id="all3" class="boxcollection" alt="커스텀아이디박스" usemap="#boxlink">
		...
		<h2 id="Text2">오류코드를 검색하고 문제를 해결하세요</h2>
			<form action="error" method="POST">
				...
				</select> <input name="er_code" placeholder="코드를 입력하세요" />
				<button>검색</button>
				<br />
