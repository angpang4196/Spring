...
public class MemberService {
	...
	MemberDao memberDao;
	/*
	 * Map<Key,Value> 키와 값의 쌍으로 구성된 자료구조 값을 추가할 때는 : map.put(key,value) 값을 읽을 때는 :
	 * map.key 형태로 값을 읽는다.
	 */
	...
	public Map<String, String> getCitiesMap() {
		...
		/*
		 * HashMap은 put한 순서대로 나열 TreeMap은 key를 기준으로 오름차순 정렬
		 */
	...
	public MemberVO userCheck(MemberVO memberVO) {
		...
		MemberVO vo = memberDao.userCheck(memberVO);
