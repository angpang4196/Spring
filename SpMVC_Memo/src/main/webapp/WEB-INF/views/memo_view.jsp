...
<script>
	// script내에서 $(function(){     }) 영역은 JQuery 영역임을 선언한다.
	$(function(){
...
<body>
	...
	<section class="w3-border w3-margin-top w3-margin-bottom">
		...
		<article>
			<button id="btn_update" type="button" class="w3-button w3-blue"> 메모수정</button>
			<button id="btn_delete" type="button" class="w3-button w3-blue"> 메모삭제</button>
		</article>
