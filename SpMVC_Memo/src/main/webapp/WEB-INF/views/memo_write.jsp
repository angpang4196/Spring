...
//		alert("반갑습니다")
		...
		*/		
		...
		/*
			var : JS에서 변수를 선언하는 keyword
			String, int 이런 형들은 없이 
			var, let 라는 keyword로 시작되면 변수 선언문
		*/
...
<%@ include file="/WEB-INF/include/include-nav.jspf" %>
	<section>
		...
		<button onclick="myfunc()" type="button" class="w3-bottom w3-purple">메모저장</button>
