...
//	SqlSession sqlSession;
	...
	// MemoDao의 selectAll() 메서드를 호출해서 SELECT SQL문을 실행한 다음
	// 결과를 memoList에 받고 아무런 가공 없이 Controller로 return;
...
//		sqlSession.commit();
	...
	public void memo_write(MemoVO vo) {
		...
		// 새로 메모를 작성했을 경우 id값이 아마도 0일 것이다.
		// 메모를 수정하기로 했을 경우는 id 값이 0 이외의 값
